...
PERSONALITIES = {
    ...
    "crypto_chad_swing": {
        ...
        "prompt": (
            ...
            "- Conditional orders: use TRAILING_STOP (12-15% trail) on winners to let them run; "
            "  use LIMIT_BUY at analyst-stated support levels to scale into oversold names. "
            ""
